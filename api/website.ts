...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (!finalPrompt && toolAnswers) {
      ...
      finalPrompt = `Crea contenido completo para un sitio web tipo "${siteType}" en español.
Paleta de colores: ${colors}.
Requisitos adicionales: ${additional || "Ninguno"}.
Incluye: headline, subtítulo, beneficios, CTA, testimonios y footer. Formato persuasivo.`;
    }
