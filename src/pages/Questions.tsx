...
const QUESTIONS: Question[] = [
  ...
  { id: 'avatar_goal', section: 'Avatar', text: '¿Cuál es su objetivo principal?', type: 'select', options: ['Escalar ingresos rápidamente', 'Tener más tiempo libre', 'Dominar su mercado local', 'Crear un sistema estable', 'Salir de su zona de confort'] },
