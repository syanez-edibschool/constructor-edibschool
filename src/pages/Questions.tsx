...
const QUESTIONS: Question[] = [
  ...
  { id: 'market_trend', section: 'Competencia', text: '¿Tendencia del mercado en tu nicho?', type: 'select', options: ['Creciendo rápidamente', 'Estable y maduro', 'En transición/disrupcción', 'Saturándose', 'Emergente (muy nuevo)'] },
